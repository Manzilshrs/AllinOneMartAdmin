...
public class RecyclerAdapterUpload extends RecyclerView.Adapter<RecyclerAdapterUpload.MyViewHolder> {

    private List<ListofPasal> listofPasals;
    private Context context;

    public RecyclerAdapterUpload(List<ListofPasal> listofPasals, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.upload_raw_layout,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, Upload_image.class);
