...
public class ListPasalUpload extends AppCompatActivity implements SearchView.OnQueryTextListener {
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private List<ListofPasal> listPasal;
    private RecyclerAdapterUpload adapter;
    private ApiInterface apiInterface;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_listof_pasal_upload);
    ...
    public void fetchPasalName(){
        ...
        call.enqueue(new Callback<List<ListofPasal>>() {
            ...
            public void onResponse(Call<List<ListofPasal>> call, Response<List<ListofPasal>> response) {
                ...
                adapter=new RecyclerAdapterUpload(listPasal,ListPasalUpload.this);
